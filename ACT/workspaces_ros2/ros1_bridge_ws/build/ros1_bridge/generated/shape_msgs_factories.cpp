...
get_factory_shape_msgs(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
  ...
  factory = get_factory_shape_msgs__msg__Mesh(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
  factory = get_factory_shape_msgs__msg__MeshTriangle(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
  factory = get_factory_shape_msgs__msg__Plane(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
  factory = get_factory_shape_msgs__msg__SolidPrimitive(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
