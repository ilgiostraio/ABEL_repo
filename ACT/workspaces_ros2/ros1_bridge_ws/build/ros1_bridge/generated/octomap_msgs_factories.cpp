...
get_factory_octomap_msgs(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
  ...
  factory = get_factory_octomap_msgs__msg__Octomap(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
  factory = get_factory_octomap_msgs__msg__OctomapWithPose(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
...
get_service_factory_octomap_msgs(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  ...
  factory = get_service_factory_octomap_msgs__srv__BoundingBoxQuery(ros_id, package_name, service_name);
  if (factory) {
    return factory;
  }
  factory = get_service_factory_octomap_msgs__srv__GetOctomap(ros_id, package_name, service_name);
  if (factory) {
    return factory;
  }
  return nullptr;
