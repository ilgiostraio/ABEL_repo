...
get_factory_visualization_msgs__msg__MarkerArray(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "visualization_msgs/msg/MarkerArray")
  {
    return std::make_shared<
      ...
      >
    >("visualization_msgs/MarkerArray", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_visualization_msgs__msg__MarkerArray(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
