...
get_factory_cartographer_ros_msgs__msg__StatusCode(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "cartographer_ros_msgs/msg/StatusCode")
  {
    return std::make_shared<
      ...
      >
    >("cartographer_ros_msgs/StatusCode", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_cartographer_ros_msgs__msg__StatusCode(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
