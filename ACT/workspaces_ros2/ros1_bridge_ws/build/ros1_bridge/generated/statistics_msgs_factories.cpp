...
get_factory_statistics_msgs(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
  ...
  factory = get_factory_statistics_msgs__msg__MetricsMessage(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
  factory = get_factory_statistics_msgs__msg__StatisticDataPoint(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
  factory = get_factory_statistics_msgs__msg__StatisticDataType(ros1_type_name, ros2_type_name);
  if (factory) {
    return factory;
  }
