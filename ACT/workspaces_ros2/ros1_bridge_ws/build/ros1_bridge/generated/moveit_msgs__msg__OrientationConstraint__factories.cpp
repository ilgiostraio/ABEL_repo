...
get_factory_moveit_msgs__msg__OrientationConstraint(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "moveit_msgs/msg/OrientationConstraint")
  {
    return std::make_shared<
      ...
      >
    >("moveit_msgs/OrientationConstraint", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_moveit_msgs__msg__OrientationConstraint(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
  ...
  moveit_msgs::msg::OrientationConstraint & ros2_msg)
{
  ...
  // convert non-array field
  // convert primitive field
  ros2_msg.absolute_x_axis_tolerance = ros1_msg.absolute_x_axis_tolerance;

  // convert non-array field
  // convert primitive field
  ros2_msg.absolute_y_axis_tolerance = ros1_msg.absolute_y_axis_tolerance;

  // convert non-array field
  // convert primitive field
  ros2_msg.absolute_z_axis_tolerance = ros1_msg.absolute_z_axis_tolerance;
  ...
  moveit_msgs::OrientationConstraint & ros1_msg)
{
  ...
  // convert non-array field
  // convert primitive field
  ros1_msg.absolute_x_axis_tolerance = ros2_msg.absolute_x_axis_tolerance;

  // convert non-array field
  // convert primitive field
  ros1_msg.absolute_y_axis_tolerance = ros2_msg.absolute_y_axis_tolerance;

  // convert non-array field
  // convert primitive field
  ros1_msg.absolute_z_axis_tolerance = ros2_msg.absolute_z_axis_tolerance;
