...
get_factory_moveit_msgs__msg__PlanningSceneComponents(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "moveit_msgs/msg/PlanningSceneComponents")
  {
    return std::make_shared<
      ...
      >
    >("moveit_msgs/PlanningSceneComponents", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_moveit_msgs__msg__PlanningSceneComponents(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
  ...
  moveit_msgs::msg::PlanningSceneComponents & ros2_msg)
{
  ...
  ros2_msg.components = ros1_msg.components;
}
  ...
  moveit_msgs::PlanningSceneComponents & ros1_msg)
{
  ...
  // convert non-array field
  // convert primitive field
  ros1_msg.components = ros2_msg.components;
}
}  // namespace ros1_bridge
