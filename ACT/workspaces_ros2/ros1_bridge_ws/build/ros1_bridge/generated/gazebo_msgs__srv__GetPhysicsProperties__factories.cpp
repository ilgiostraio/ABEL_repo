...
get_factory_gazebo_msgs__srv__GetPhysicsProperties(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
  (void)ros1_type_name;
  (void)ros2_type_name;
...
get_service_factory_gazebo_msgs__srv__GetPhysicsProperties(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  if (
    (
      ...
      service_name == "GetPhysicsProperties"
    ) || (
      ros_id == "ros2" &&
      package_name == "gazebo_msgs" &&
      service_name == "srv/GetPhysicsProperties"
    )
  ) {
...
void ServiceFactory<
  ...
  gazebo_msgs::srv::GetPhysicsProperties
>::translate_1_to_2(
  const gazebo_msgs::GetPhysicsProperties::Request& req1,
  gazebo_msgs::srv::GetPhysicsProperties::Request& req2
) {
}
...
void ServiceFactory<
  ...
  gazebo_msgs::srv::GetPhysicsProperties
>::translate_1_to_2(
  const gazebo_msgs::GetPhysicsProperties::Response& req1,
  gazebo_msgs::srv::GetPhysicsProperties::Response& req2
) {
  auto & time_step1 = req1.time_step;
  auto & time_step2 = req2.time_step;
  time_step2 = time_step1;
  auto & pause1 = req1.pause;
  auto & pause2 = req2.pause;
  pause2 = pause1;
...
void ServiceFactory<
  ...
  gazebo_msgs::srv::GetPhysicsProperties
>::translate_2_to_1(
  const gazebo_msgs::srv::GetPhysicsProperties::Request& req2,
  gazebo_msgs::GetPhysicsProperties::Request& req1
) {
}
...
void ServiceFactory<
  ...
  gazebo_msgs::srv::GetPhysicsProperties
>::translate_2_to_1(
  const gazebo_msgs::srv::GetPhysicsProperties::Response& req2,
  gazebo_msgs::GetPhysicsProperties::Response& req1
) {
  auto & time_step1 = req1.time_step;
  auto & time_step2 = req2.time_step;
