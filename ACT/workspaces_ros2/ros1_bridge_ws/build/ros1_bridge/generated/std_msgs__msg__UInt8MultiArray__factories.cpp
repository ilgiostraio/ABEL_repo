...
get_factory_std_msgs__msg__UInt8MultiArray(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "std_msgs/msg/UInt8MultiArray")
  {
    return std::make_shared<
      ...
      >
    >("std_msgs/UInt8MultiArray", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_std_msgs__msg__UInt8MultiArray(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
