...
get_factory_geometry_msgs__msg__InertiaStamped(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "geometry_msgs/msg/InertiaStamped")
  {
    return std::make_shared<
      ...
      >
    >("geometry_msgs/InertiaStamped", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_geometry_msgs__msg__InertiaStamped(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
  ...
  geometry_msgs::msg::InertiaStamped & ros2_msg)
{
  ...
  >::convert_1_to_2(
    ros1_msg.inertia, ros2_msg.inertia);
}
  ...
  geometry_msgs::InertiaStamped & ros1_msg)
{
  ...
  Factory<
    ...
    geometry_msgs::msg::Inertia
  >::convert_2_to_1(
    ros2_msg.inertia, ros1_msg.inertia);
}
}  // namespace ros1_bridge
