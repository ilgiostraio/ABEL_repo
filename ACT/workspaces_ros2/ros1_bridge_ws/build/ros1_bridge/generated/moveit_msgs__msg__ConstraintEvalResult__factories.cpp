...
get_factory_moveit_msgs__msg__ConstraintEvalResult(const std::string & ros1_type_name, const std::string & ros2_type_name)
{
    ...
    ros2_type_name == "moveit_msgs/msg/ConstraintEvalResult")
  {
    return std::make_shared<
      ...
      >
    >("moveit_msgs/ConstraintEvalResult", ros2_type_name);
  }
  return std::shared_ptr<FactoryInterface>();
}

std::unique_ptr<ServiceFactoryInterface>
get_service_factory_moveit_msgs__msg__ConstraintEvalResult(const std::string & ros_id, const std::string & package_name, const std::string & service_name)
{
  (void)ros_id;
  (void)package_name;
  (void)service_name;
  ...
  moveit_msgs::msg::ConstraintEvalResult & ros2_msg)
{
  ...
  ros2_msg.result = ros1_msg.result;

  // convert non-array field
  // convert primitive field
  ros2_msg.distance = ros1_msg.distance;
}
  ...
  moveit_msgs::ConstraintEvalResult & ros1_msg)
{
  ...
  // convert non-array field
  // convert primitive field
  ros1_msg.result = ros2_msg.result;

  // convert non-array field
  // convert primitive field
  ros1_msg.distance = ros2_msg.distance;
}
}  // namespace ros1_bridge
