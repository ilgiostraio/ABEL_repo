...
namespace TerminalFace
{
    public class Runner
    {
        ...
        public static void sendLookAt(decimal x, decimal y)
        {
            Winner w = new Winner(0, (float)x, (float)y);
                ...
                while ((line = streamReader.ReadLine()) != null)
                {
                    switch (line.Split(' ')[0])
                    {
                        ...
                        case "lookat":
                            ...
                            sendLookAt(Convert.ToDecimal(line.Split(' ')[1],culture), Convert.ToDecimal(line.Split(' ')[2],culture));
                            break;
                        case "sleep":
